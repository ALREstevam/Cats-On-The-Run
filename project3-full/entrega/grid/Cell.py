...
class Cell:
    ...
    # Construtor
    def __init__(self, x, y, grid, is_goal=False, is_wall=False, difficulty=0.1):
        '''
    ...
    def __getattr__(self, item):
        if item in ('neighbors', 'neib', 'neibors', 'neibours', 'vizinhos'):#se for feito algo como `cell.neibors`
