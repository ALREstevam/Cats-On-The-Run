...
class AstarCat(CatFather):
    ...
    def find_path(self, start_cell, end_cell):
        ...
        ##
        if self.start.is_wall or self.end.is_wall:
            self.fill_path(self.start, True)
        ...
        while solve_status not in [Solution.FINDED, Solution.NO_SOLUTION] and iteration_counter != self.max_iterations:
            ...
            if len(self.open_set) > 0:
                ...
                for neighbor in set(current.neighbors.keys()):
                    ...
                    if not neighbor in self.closed_set and not neighbor.is_wall and neighbor.pos not in self.disallowed_cells:
                        ...
                        if neighbor in self.open_set:
                            ...
                            if tempg < neighbor.vars['g']:
                                ...
                                has_new_path = True  # O caminho mudou (uma flag)
